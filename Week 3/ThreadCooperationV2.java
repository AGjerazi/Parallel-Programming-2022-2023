/*
 * This example is an extension to the ThreadCooperation example.
 * If the WithdrawTask thread is waiting for a new deposit, then the
 * DepositTask will signal only if the new amount is greater than or
 * equal to the amount requested to be withdrawn.
 */
